...
static var adlibs_singular : Array[String] = [
	...
	"They definitely carried a{vowel} {adjective} {noun}",
...
static var adlibs_plural : Array[String] = [
	...
	"Pretty sure they were carrying {adjective} {noun}",
...
static var adlibs_singular_binary : Array[String] = [
	...
	"They were definitely carrying a{vowel} {noun}",
	"Rumor is they’ve got a{vowel} {noun}",
...
static var adlibs_plural_binary : Array[String] = [
	...
	"I could’ve sworn they were carrying {noun}",
...
static var adlibs_singular_negative_binary : Array[String] = [
	...
	"They definitely weren't carrying a{vowel} {noun}",
...
static var adlibs_plural_negative_binary : Array[String] = [
	...
	"They definitely weren't carrying {noun}",
